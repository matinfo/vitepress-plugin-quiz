...
/**
 * Parse inline markdown: **bold**, *italic*, `code` → typed parts array.
 * Used for question titles, answer text, and explanations.
 */
type RichPart = { type: "text" | "bold" | "italic" | "code"; value: string }

function parseRichText(text: string): RichPart[] {
